...
class ReflectionFactoryProviderTest extends TestCase
{
    /**
     * @test
     */
    ...
    {
        self::assertEquals(ReflectionFactoryProvider::KEY, ReflectionFactoryProvider::getKey());
    }
    ...
    {
        $reflectionFactoryProvider = new ReflectionFactoryProvider();
        $reflectionFactory = $reflectionFactoryProvider();

        self::assertInstanceOf(ReflectionFactory::class, $reflectionFactory);
    }
}
